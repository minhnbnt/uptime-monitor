...
- Tests: `ontimecalc_test.go`, `ontimerange_test.go`, `ontime_test.go`, `ontime_integration_test.go`, `ontime_integration_extra_test.go` updated to the new signatures/shapes.